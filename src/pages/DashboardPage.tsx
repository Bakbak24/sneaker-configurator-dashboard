                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start flex-col xs:flex-row xs:items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">
                          {selectedOrder.laceColor?.color || "none"}
                        </span>
                        <span className="text-xs text-gray-600">
                          (Material:{" "}
                          {selectedOrder.laceColor?.material || "none"})
                        </span>
                      </div>
                    </li>
                    <li className="flex items-start flex-col xs:flex-row xs:items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        ></div>
                        <span className="text-sm">
                          {selectedOrder.soleColor?.color || "none"}
                        </span>
                        <span className="text-xs text-gray-600">
                          (Material:{" "}
                          {selectedOrder.soleColor?.material || "none"})
                        </span>
                      </div>
                    </li>
                    <li className="flex items-start flex-col xs:flex-row xs:items-center gap-2">
                      <strong className="text-sm min-w-fit">
                        Tongue Color:
                      </strong>
                      <div className="flex items-center gap-2">
                        <div
                        ...
                        ></div>
                        <span className="text-sm">
                          {selectedOrder.tongueColor?.color || "none"}
                        </span>
                        <span className="text-xs text-gray-600">
                          (Material:{" "}
                    ...
                    <li className="flex items-start flex-col xs:flex-row xs:items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        ></div>
                        <span className="text-sm">
                          {selectedOrder.tipColor?.color || "none"}
                        </span>
                        <span className="text-xs text-gray-600">
                          (Material:{" "}
                          {selectedOrder.tipColor?.material || "none"})
                        </span>
                      </div>
                    </li>
                  </ul>
