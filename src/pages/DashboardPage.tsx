  ...
  return (
    <div className="min-h-screen flex bg-gray-100">
      ...
      <main className="flex-1 p-8 bg-white">
        <h1 className="text-2xl font-bold text-gray-800 mb-4">Orders Overview</h1>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      ...
                      <span className="ml-2">(Material: {selectedOrder.laceColor?.material || 'none'})</span>
                    </li>
                    <li className="flex items-center">
                      ...
                      <span className="ml-2">(Material: {selectedOrder.soleColor?.material || 'none'})</span>
                    </li>
                    <li className="flex items-center">
                      ...
                      <span className="ml-2">(Material: {selectedOrder.tongueColor?.material || 'none'})</span>
                    </li>
                    <li className="flex items-center">
                      ...
                      <span className="ml-2">(Material: {selectedOrder.tipColor?.material || 'none'})</span>
                    </li>
                  </ul>
                </div>
